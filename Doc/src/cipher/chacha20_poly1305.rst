...
`ChaCha20-Poly1305`_ is an authenticated cipher with associated data (AEAD) defined in `RFC7539`_.
...
An instance of the cipher can only encrypt up to 256GB of data (no matter how long the nonce is).
