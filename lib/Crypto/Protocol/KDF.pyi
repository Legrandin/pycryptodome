...
def PBKDF2(password: Union[bytes, str], salt: Union[bytes, str], dkLen: Optional[int]=16, count: Optional[int]=1000, prf: Optional[RNG]=None, hmac_hash_module: Optional[ModuleType]=None) -> bytes: ...
