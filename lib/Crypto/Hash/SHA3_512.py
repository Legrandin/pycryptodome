...
__all__ = ['new', 'digest_size', 'SHA3_512Hash' ]

from Crypto.Util.py3compat import *
from Crypto.Hash.hashalgo import HashAlgo

from Crypto.Hash import _SHA3_512
hashFactory = _SHA3_512

class SHA3_512Hash(HashAlgo):
    """Class that implements a SHA3_512 hash
    ...
    #:
    #:
    #: This value uniquely identifies the SHA3_512 algorithm.
    oid = b('*-not yet assigned-*')

    digest_size = _SHA3_512.digest_size
    block_size = _SHA3_512.block_size
...
def new(data=None):
    ...
    :Parameters:
       data : byte string
        ...
        It is equivalent to an early call to `SHA3_512Hash.update()`.
        Optional.

    :Return: A `SHA3_512Hash` object
    """
    return SHA3_512Hash().new(data)
