...
class DerObject:
    payload: bytes
    def __init__(self, asn1Id: Optional[int]=None, payload: Optional[bytes]=b(''), implicit: Optional[int]=None,
...
class DerOctetString(DerObject):
    payload: bytes
    def __init__(self, value: Optional[bytes]=b(''), implicit: Optional[int]=None) -> None: ...
...
class DerBitString(DerObject):
    value: bytes
    def __init__(self, value: Optional[bytes]=b(''), implicit: Optional[int]=None, explicit: Optional[int]=None) -> None: ...
    def encode(self) -> bytes: ...
